...
NIRA self-maintenance uses deterministic failure classification, adaptive queue capacity, exact-head change-impact planning, independent CI/security evidence, and fail-closed promotion. Exhausted AI provider capacity blocks only the AI lane; deterministic factory work remains available.
