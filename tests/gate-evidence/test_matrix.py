...
def ev(x,b=None):return c.GateEvidence('repo','a'*40,status=c.EvidenceStatus(x),branch=b,timestamp='2026-09-04T00:00:00+03:30')
...
def test_wrong_branch():assert m.evaluate_matrix('repo','a'*40,[ev('SUCCESS','main')],expected_branch='feature').decision==m.PromotionDecision.BLOCK
