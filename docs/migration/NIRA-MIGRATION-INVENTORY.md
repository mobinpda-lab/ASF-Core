...
|---|---|---|---|---|---|---|
| Earlier factory foundation | Independent factory control-plane boundary | historical source commits; current `factory/*` | Generic factory authority | Preserve and evolve | NIRA Core/Engine/Runtime | High if duplicated |
| Earlier factory foundation | Contracts, lifecycle, gates, evidence, recovery | factory/contracts; factory/gates; factory/recovery; factory/runtime | Fail-closed factory primitives | Reuse/redesign, do not duplicate | NIRA Core | High |
| Earlier factory foundation | Registered-client conformance | factory/tests/test_registered_client_e2e.py | Deterministic lifecycle proof | Preserve as conformance only | NIRA Evidence/Tests | Medium; not L10 proof |
| Earlier factory foundation | Real client registry | commit 90a5f11 | Registry-driven client boundary | Preserve | NIRA Registry | Medium |
| Earlier factory foundation | Promotion hardening | commits afe4c76, b73d6fb | Exact HEAD/base, CI, artifact, fail-closed promotion | Preserve | NIRA Promotion/Governance | High |
| Earlier operating model | Historical source knowledge | isolated in `docs/history/NIRA_IDENTITY_HISTORY.md` | Preserve provenance without active authority | Preserve as history only | NIRA Governance/Memory | High |
...
- Historical naming is isolated in `docs/history/NIRA_IDENTITY_HISTORY.md` and must not be copied into active implementation.
